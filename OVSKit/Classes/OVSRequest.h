...
-(void)request:(URLRequestMethod)method url:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security  onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;

-(void)requestV1:(URLRequestMethod)method url:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security contentType:(RequestContentType)contentType forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;


///post request method
-(void)postV2:(NSString *)url params:(NSDictionary *)params timeoutInterval:(double)timeoutInterval isBodyParams:(BOOL)isBodyParams extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security contentType:(RequestContentType)contentType dispatchQueue:(dispatch_queue_t)dispatchQueue forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;

-(void)postV1:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;

-(void)post:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
...
///put request method
-(void)putV1:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
-(void)put:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
-(void)putV2:(NSString *)url params:(NSDictionary *)params timeoutInterval:(double)timeoutInterval isBodyParams:(BOOL)isBodyParams extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security contentType:(RequestContentType)contentType dispatchQueue:(dispatch_queue_t)dispatchQueue forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;

///delete request method
-(void)deleteV1:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
-(void)delete:(NSString *)url params:(NSDictionary *)params extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
-(void)deleteV2:(NSString *)url params:(NSDictionary *)params timeoutInterval:(double)timeoutInterval isBodyParams:(BOOL)isBodyParams extraHeader:(NSDictionary*)extraHeader security:(RequestDataSecurity)security contentType:(RequestContentType)contentType dispatchQueue:(dispatch_queue_t)dispatchQueue forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;

///post data request method
-(void)postDataV1:(NSString *)url params:(NSDictionary *)params formParams:(NSArray<MultipartFormDataParam *> *)formParams extraHeader:(NSDictionary *)extraHeader security:(RequestDataSecurity)security forDownloading:(BOOL)forDownloading uploadProgress:(UploadingCallback)uploadProgress downloadProgress:(DownloadingCallback)downloadProgress onRedirect:(RedirectCallback)onRedirect onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
...
-(void)postData:(NSString *)url params:(NSDictionary *)params formParams:(NSArray<MultipartFormDataParam *> *)formParams extraHeader:(NSDictionary *)extraHeader security:(RequestDataSecurity)security onSuccess:(successCallback)onSuccess onFailure:(errorCallback)onFailure;
